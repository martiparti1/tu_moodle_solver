    ...
    return(
        <>
            ...
            <div className="min-h-screen bg-gray-500 flex justify-center items-center">
                <div className="min-h-[50dvh] min-w-[70dvw] bg-white rounded-lg shadow-black flex flex-col justify-center items-center">
                    ...
                    <div className={`flex flex-row justify-between items-center min-w-[50dvw]`}>
                        <input 
                            type="text" 
